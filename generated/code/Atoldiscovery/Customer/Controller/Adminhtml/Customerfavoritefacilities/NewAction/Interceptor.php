<?php
namespace Atoldiscovery\Customer\Controller\Adminhtml\Customerfavoritefacilities\NewAction;

/**
 * Interceptor class for @see \Atoldiscovery\Customer\Controller\Adminhtml\Customerfavoritefacilities\NewAction
 */
class Interceptor extends \Atoldiscovery\Customer\Controller\Adminhtml\Customerfavoritefacilities\NewAction implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'initPage');
        if (!$pluginInfo) {
            return parent::initPage($resultPage);
        } else {
            return $this->___callPlugins('initPage', func_get_args(), $pluginInfo);
        }
    }
