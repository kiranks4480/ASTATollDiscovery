...
abstract class Customerfavoritefacilities extends \Magento\Backend\App\Action
{
    ...
    public function initPage($resultPage)
    {
        $resultPage->setActiveMenu(self::ADMIN_RESOURCE)
            ...
            ->addBreadcrumb(__('Customer Favorite Facilities'), __('Customer Favorite Facilities'));
        return $resultPage;
    }
}
